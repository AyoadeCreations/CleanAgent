...
const actions = [
  {
    ...
    detail: "Mint a verifiable invoice",
  ...
  },
  {
    ...
    title: "Create report",
    detail: "Generate a signed audit report",
  ...
  },
  {
    icon: BotIcon,
    title: "Create agent",
    detail: "Scoped autonomous payment agent",
  ...
  },
  {
    ...
    detail: "Pass CVI identity verification",
    href: "/onboarding",
  ...
  },
  {
    ...
    detail: "Evaluate policy and risk",
